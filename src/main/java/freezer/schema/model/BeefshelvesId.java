...
/**
 * BeefshelvesId generated by hbm2java
 */
public class BeefshelvesId implements java.io.Serializable {
	...
	public BeefshelvesId() {
	}

	public BeefshelvesId(int location, String i1, String i2, String i3, String i4, String i5, String i6, String i7,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BeefshelvesId))
			return false;
		BeefshelvesId castOther = (BeefshelvesId) other;
