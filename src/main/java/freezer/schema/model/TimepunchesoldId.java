...
/**
 * TimepunchesoldId generated by hbm2java
 */
public class TimepunchesoldId implements java.io.Serializable {
	...
	public TimepunchesoldId() {
	}

	public TimepunchesoldId(int counter) {
		this.counter = counter;
	}

	public TimepunchesoldId(int counter, String intime, String otl, String ifl, String outTime, String extraIn,
			String extraOut) {
		this.counter = counter;
		this.intime = intime;
		this.otl = otl;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TimepunchesoldId))
			return false;
		TimepunchesoldId castOther = (TimepunchesoldId) other;
