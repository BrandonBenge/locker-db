...
/**
 * DeershelfiiId generated by hbm2java
 */
public class DeershelfiiId implements java.io.Serializable {
	...
	public DeershelfiiId() {
	}

	public DeershelfiiId(String location, String i1, String i2, String i3, String i4, String i5) {
	...
	public DeershelfiiId(String location, String i1, String i2, String i3, String i4, String i5, String i6, String i7,
			String i8) {
		this.location = location;
		this.i1 = i1;
		this.i2 = i2;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DeershelfiiId))
			return false;
		DeershelfiiId castOther = (DeershelfiiId) other;

		return ((this.getLocation() == castOther.getLocation()) || (this.getLocation() != null
				&& castOther.getLocation() != null && this.getLocation().equals(castOther.getLocation())))
				&& ((this.getI1() == castOther.getI1()) || (this.getI1() != null && castOther.getI1() != null
						&& this.getI1().equals(castOther.getI1())))
