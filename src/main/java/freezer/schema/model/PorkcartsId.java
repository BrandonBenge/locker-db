...
/**
 * PorkcartsId generated by hbm2java
 */
public class PorkcartsId implements java.io.Serializable {
	...
	public PorkcartsId(int location, String i1, String i2, String i3, String i4, String i5, String i6, String i7,
			String i8) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PorkcartsId))
			return false;
		PorkcartsId castOther = (PorkcartsId) other;
