...
/**
 * QuickfreezeId generated by hbm2java
 */
public class QuickfreezeId implements java.io.Serializable {
	...
	public QuickfreezeId() {
	}

	public QuickfreezeId(int location) {
		this.location = location;
	}

	public QuickfreezeId(int location, String i1, String i2, String i3, String i4, String i5, String i6, String i7,
			String i8) {
		this.location = location;
		this.i1 = i1;
		this.i2 = i2;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QuickfreezeId))
			return false;
		QuickfreezeId castOther = (QuickfreezeId) other;
