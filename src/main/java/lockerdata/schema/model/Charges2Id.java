...
/**
 * Charges2Id generated by hbm2java
 */
public class Charges2Id implements java.io.Serializable {
	...
	public Charges2Id(String myItem, BigDecimal cost, String category) {
		this.myItem = myItem;
		this.cost = cost;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Charges2Id))
			return false;
		Charges2Id castOther = (Charges2Id) other;
